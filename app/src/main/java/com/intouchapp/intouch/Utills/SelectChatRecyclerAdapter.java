...
public class SelectChatRecyclerAdapter extends RecyclerView.Adapter<SelectChatRecyclerAdapter.MyOwnHolder> {
    ...
    public SelectChatRecyclerAdapter(List<String> list, String type, Context cnt){
